/**
 * @file Screen-level components — Dashboard, Customers, Loans, Search,
 *       Settings, CustomerDetail, and LoanDetail. Each is a pure
 *       render-function that receives props from the controller.
 */
...
/**
 * Dashboard — portfolio overview with stat grid, month-wise interest status,
 * and due-soon list.
 */
export function DashboardScreen({
    ...
    const { paid, unpaid } = React.useMemo(() => {
        return getMonthwiseInterestSummary(state.loans, state.payments, selectedMonth);
    ...
    return (
        ...
        >
            <Text style={styles.dashboardWelcome}>Your lending portfolio</Text>
            ...
            <Section title="Interest Status By Month">
                ...
                <View style={{ gap: 12 }}>
                    <View>
                        <Text style={[styles.groupTitle, { color: "#16a34a", marginBottom: 6 }]}>
                            Paid ({paid.length})
                        </Text>
                        {paid.length === 0 ? (
                            <Text
                    ...
                    >
                        <Text style={[styles.groupTitle, { color: "#dc2626", marginBottom: 6 }]}>
...
/**
 * Customer list screen with pull-to-refresh.
 */
    ...
    return (
        <ScreenList
            ...
            renderItem={(customer) => (
                ...
                >
                    <AvatarMemo name={customer.fullName} />
                    <View style={{ flex: 1 }}>
...
/**
 * Loan list screen with pull-to-refresh, showing balance and risk status per loan.
 */
...
/**
 * Cross-entity search screen — searches customers, vehicles, and loans by query.
 */
...
/**
 * Settings screen — shows storage info and data reset option.
 */
        ...
        <ScrollView contentContainerStyle={styles.scroll}>
            <Section title="Local storage">
                <Text style={styles.bodyText}>
                    The app currently stores customers, vehicles, loans, payments, and documents in
...
/**
 * Customer detail — profile info, collateral list, loan list, and document vault.
 */
export function CustomerDetailScreen({
    ...
    const documents = state.documents.filter((doc) => doc.customerId === customer.id);
            ...
            >
                {customer.vehicles.length === 0 ? (
                    ...
                    customer.vehicles.map((col) => {
                        ...
                        const isVehicle = col.vehicleType === "Bike" || col.vehicleType === "Car";
...
/**
 * Loan detail — summary card, payment history grouped by month, and add-payment button.
 */
